...
function App() {
  return (
    <>
      ...
      <ProjectsContainer>
        <ProjectBox projectName='Postify' projectDescription='A basic social media website written with PHP. University Project for Advanced Web Development course.' projectBanner={postifySite} bannerAlt='Postify banner logo' buttons={{ github: 'https://github.com/YAJATapps/Postify' }} />
