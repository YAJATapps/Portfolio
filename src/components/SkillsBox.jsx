        ...
        return (
            <div
                ...
                <h1 className='About-text'>
                    <ul>
                        <li>Languages: Java, JavaScript, Python (Proficient) Intermediate: Kotlin, C#, PHP, Swift, C++ AWS: Serverless platform, Virtual machines, API gateway, DNS, and Web app deployment</li>
